...
getMoviesFromServer((moviesApiResult) => {
  //   console.log(`result api: ${moviesApiResult.Search}`);
  if (!Array.isArray(moviesApiResult.Search)) return;
  const moviesNames = moviesApiResult.Search.map((movie) => movie.Title);
